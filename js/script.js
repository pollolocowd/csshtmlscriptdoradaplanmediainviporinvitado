...
const preguntas = [
  {
    pregunta: "¿Cuál es el color favorito de Fabiola?",
    opciones: ["Azul", "Rosa", "Plata", "Morado"],
    correcta: 2
  },
  {
    pregunta: "¿Quién es el artista favorito de Fabiola?",
    opciones: ["Bad Bunny", "Taylor Swift", "Shakira", "Ed Sheeran"],
    correcta: 1
  },
  {
    pregunta: "¿Cuál es la serie favorita de Fabiola?",
    opciones: ["Stranger Things", "The Witcher", "Friends", "Gossip Girl"],
    correcta: 3
  },
  {
    pregunta: "¿Cuál es el deporte que más le gusta a Fabiola?",
    opciones: ["Fútbol", "Natación", "Tenis", "Básquetbol"],
    correcta: 1
  },
  {
    pregunta: "¿Cuál es la comida favorita de Fabiola?",
...
if(invitado){
  // Cambiar agradecimiento final
  document.getElementById("agradecimiento").innerHTML =
    "Tu presencia hará este día aún más especial <b>"+invitado+"</b>";
  
  // Cambiar nombre en el intro
  document.querySelector("#intro h1").innerText = "Invitación para " + invitado;
  
  // NO cambiar el nombre de la XVañera en la portada, dejar "María"
  // document.querySelectorAll(".section h1")[0].innerText = invitado; // <-- eliminar esta línea
}
